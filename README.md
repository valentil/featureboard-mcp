...
and it came together fast. What you get is ~215 tools spanning the entire product surface:
...
> for a clean start. Turn that off in the extension settings to expose the full ~215-tool
