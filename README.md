...
and it came together fast. What you get is ~213 tools spanning the entire product surface:
...
1. Install the extension: double-click `featureboard-0.7.1.mcpb`, or Claude Desktop →
...
> for a clean start. Turn that off in the extension settings to expose the full ~213-tool
